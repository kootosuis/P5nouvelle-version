...
let totalQuantity = 0;
let totalPrice = 0;
let totalOrder = document.querySelectorAll("#cart__items");
let pricePerLine = 0;
...
// let articleList = document.querySelectorAll(".deleteItem");
// console.log(articleList);

// for (i=0; articleList.length; i++){
//      articleList[i].addEventListener("click", (event) => {
//           event.preventDefault();
//           let idArticleDelete = articleList[i].id
//           cart = cart.filter(elt => elt.id !== idArticleDelete)
//      })
// }
